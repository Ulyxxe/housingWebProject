  ...
  <div class="header-inner">
    ...
    <div class="header-group-right">
      <div class="header-actions">
        ...
        <?php else: ?>
          <a href="/login" class="header-button auth-button" data-lang-key="nav_signin_app">Sign In</a>
          <a href="/register" class="header-button auth-button primary" data-lang-key="nav_register_app">Register</a>
        <?php endif; ?>
      </div>
    </div>
